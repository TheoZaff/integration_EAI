...
namespace Articy.Eai.Templates
{
    ...
    [Serializable()]
    public class IndiceTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Eai.Templates.IndiceTemplate newClone = ((Articy.Eai.Templates.IndiceTemplate)(aClone));
            if ((Indice != null))
            {
        ...
        {
            Articy.Eai.Templates.IndiceTemplate clone = new Articy.Eai.Templates.IndiceTemplate();
