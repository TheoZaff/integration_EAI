...
namespace Articy.Eai.Templates
{
    ...
    public class ModelTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Eai.Templates.ModelTemplateTemplate newClone = ((Articy.Eai.Templates.ModelTemplateTemplate)(aClone));
            if ((dialogue != null))
            {
        ...
        {
            Articy.Eai.Templates.ModelTemplateTemplate clone = new Articy.Eai.Templates.ModelTemplateTemplate();
